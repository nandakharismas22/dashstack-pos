...

                    {
                        ...
                        <>
                            ...
                            <form onSubmit={(e) => submitForm(e)}>
                                ...
                                <div className='text-center mt-4'>Don't have an account yet? <Link to="/login"><button className="  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">Login</button></Link></div>
                            </form>
                        </>
                    }
